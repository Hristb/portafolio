...
Todo el desarrollo está impulsado por **IA** — utilizo **GitHub Copilot** con prácticas avanzadas de **Prompt Engineering** y la metodología **SDD (Spec-Driven Development)** como estructura de trabajo. Adicionalmente, apoyo al área operativa con análisis y monitoreo de incidencias usando el stack **ELK** (Elasticsearch, Logstash, Kibana).
